<template>
  <div class="card">
    <div id="card__title--subtitle__text">
    <h1 class="card__title" v-if="mode == 'login'">Connexion</h1>
    <h1 class="card__title" v-else>Inscription</h1>
    <p class="card__subtitle" v-if="mode == 'login'">Tu n'as pas encore de compte ? <span class="card__action" @click="switchToRegister()">Créer un compte</span></p>
    <p class="card__subtitle card__subtitle--connect" v-else>Tu possèdes déjà un compte ? <span class="card__action" @click="switchToLogin()">Se connecter</span></p>
    </div>
    <div class="form-row">
